...
signal mem : rom := (
     -- B"000000_00000_00000_00000_00000_000000",
        ...
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000" 
        ...
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_01001_01001_00001_000000", -- sll $9, $9, 1          X"00094840"
        B"000100_01001_01000_00000_00000_001101", -- beq $0, $4, 26         X"1128000D"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00100_01000_00000_001000", -- slt $8, $0, $4, greaterX"00044008"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000100_01000_01001_00000_00000_001011", -- beg $9, $8, 23         X"1109000B"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00000_00100_00000_00000_000010", -- sub $0, $0, $4         X"00040002"
        B"111111_00000_00000_00000_00000_000110", -- j 9                    X"FC00000D"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        B"000000_00100_00000_00100_00000_000010", -- sub $4, $4, $0         X"00802002"
        B"111111_00000_00000_00000_00000_000110", -- j 9                    X"FC000006"
        B"000000_00000_00000_00000_00000_000000", -- sll $0, $0, 0          X"00000000"
        others => X"00000000"
);
